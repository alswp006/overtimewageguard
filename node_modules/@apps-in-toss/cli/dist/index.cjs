...
var require_common = __commonJS({
  "../../../.yarn/__virtual__/debug-virtual-5f733de965/0/cache/debug-npm-4.4.0-f1ca372596-db94f1a182.zip/node_modules/debug/src/common.js"(exports2, module2) {
    "use strict";
    init_cjs_shims();
    function setup(env) {
...
var require_browser = __commonJS({
  "../../../.yarn/__virtual__/debug-virtual-5f733de965/0/cache/debug-npm-4.4.0-f1ca372596-db94f1a182.zip/node_modules/debug/src/browser.js"(exports2, module2) {
    "use strict";
    init_cjs_shims();
...
var require_node = __commonJS({
  "../../../.yarn/__virtual__/debug-virtual-5f733de965/0/cache/debug-npm-4.4.0-f1ca372596-db94f1a182.zip/node_modules/debug/src/node.js"(exports2, module2) {
    "use strict";
    init_cjs_shims();
    var tty = require("tty");
...
var require_src = __commonJS({
  "../../../.yarn/__virtual__/debug-virtual-5f733de965/0/cache/debug-npm-4.4.0-f1ca372596-db94f1a182.zip/node_modules/debug/src/index.js"(exports2, module2) {
    "use strict";
    init_cjs_shims();
...
var DeployCommand = class extends import_clipanion.Command {
  ...
  profile = import_clipanion.Option.String("--profile", {
    required: false,
  ...
  location = import_clipanion.Option.String("--location", {
    description: "\uC5C5\uB85C\uB4DC\uD560 .ait \uD30C\uC77C\uC758 \uACBD\uB85C\uB97C \uBA85\uC2DC\uC801\uC73C\uB85C \uC9C0\uC815\uD574\uC694. \uAE30\uBCF8\uAC12\uC740 \uD604\uC7AC \uD328\uD0A4\uC9C0 \uB8E8\uD2B8 \uB514\uB809\uD1A0\uB9AC\uC5D0 \uC788\uB294 ait \uD30C\uC77C\uC774\uC5D0\uC694.",
    required: false
  });
  schemeOnly = import_clipanion.Option.Boolean("--scheme-only", {
    required: false,
  ...
  async execute() {
    ...
    if (this.workspace) {
      p.log.warn("(deprecated) --workspace \uC635\uC158\uC740 \uC774\uC81C \uC0AC\uC6A9\uD558\uC9C0 \uC54A\uC544\uC694. \uC774 \uC635\uC158 \uB300\uC2E0 --profile \uC635\uC158\uC744 \uC0AC\uC6A9\uD574\uC8FC\uC138\uC694.");
    }
    ...
    try {
      ...
      const { appName, deploymentId } = await (async () => {
        if (format === import_ait_format.AppsInTossBundle.Format.AIT) {
          ...
          const rawAppManifest = await (0, import_utils.readZipContent)(resolvedArtifactPath, APP_MANIFEST_NAME);
...
`);
      ...
      p.note(this.decorate(result, import_picocolors.default.green));
    }
  }
  printError(error) {
    if (this.schemeOnly) {
...
`);
  ...
  getArtifactPath(location) {
    if (location) {
      ...
      return import_path2.default.resolve(location);
    }
    ...
    return import_path2.default.resolve(packageRoot, artifactFile);
  }
};
...
var TokenAddCommand = class extends import_clipanion4.Command {
  ...
  profile = import_clipanion4.Option.String({ required: false });
